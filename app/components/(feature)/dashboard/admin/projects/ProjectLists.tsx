...
const ProjectLists = ({
  ...
  const handleActionClick = async (action: string, projectSlug: string) => {
    ...
    const project = optimisticProjects.find(
      (p) => p.project_slug === projectSlug
    );
    ...
    if (action === "view") {
      ...
      setOptimisticProjects(
        optimisticProjects.filter((p) => p.project_id !== projectId)
      );
      ...
      <div className="hidden lg:block">
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody>
              {optimisticProjects.map(
                (project: ProjectItemDashboardResponse, index: number) => (
                  <motion.tr
                    ...
                    <td className="py-3 lg:py-4 px-3 lg:px-4">
                      <div className="flex justify-end space-x-1 lg:space-x-2">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          onClick={() =>
                            handleActionClick("view", project.project_slug)
                          }
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          onClick={() =>
                            handleActionClick("edit", project.project_slug)
                          }
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          onClick={() =>
                            handleActionClick("delete", project.project_slug)
                          }
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      <button
                        onClick={() =>
                          handleActionClick("title_click", project.project_slug)
                        }
                  ...
                  <div className="flex space-x-1">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() =>
                        handleActionClick("togglePublish", project.project_slug)
                      }
